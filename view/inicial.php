...
<body>
	...
	<div class="sair"><a href="forms/sair.php" id="sair_a">Sair</a></div>
	<div class="topo" id="topo">
		...
		<div class="centro" id="centro" onload="requisitar();">
		...
		<content id="topo_input">
			...
			<form action="#" id="enviarM" method="POST">
				<input id="topo_input_form"  autocomplete="off" type="text" placeholder="Digite uma mensagem" name="mensagem" autofocus>
	...
	<script type="text/javascript" >
		...
		window.setInterval(requisitar, 5000);
	</script>
</body>
</html>